...
export const ProgressCell: FunctionComponent<ProgressCellProps> = (props) => {
    return (
        <>
            ...
            <div className="Settings__number-minus-btn Settings__time-cell Settings__controls-cell"></div>
            <h3 className="Settings__time-cell Settings__count-cell">{props.count}</h3>
            <div className="Settings__number-plus-btn Settings__time-cell Settings__controls-cell"></div>
        </> 
        )
}
